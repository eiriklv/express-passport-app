...
function htmlGetRequestOptions(url) {
  return {
    uri: url,
    method: 'GET',
  ...
  describe('Local HTML', function() {
    describe('login form', function() {
      it('should render', function(done) {
        rp(htmlGetRequestOptions('http://localhost:3000/auth/local/login'))
          .then(function (res) {
    ...
    describe('forgot form', function() {
      it('should render', function(done) {
        rp(htmlGetRequestOptions('http://localhost:3000/auth/local/forgot'))
          .then(function (res) {
            expect(res.indexOf('<form')).to.not.eq(-1);
          })
          .catch(function (err) {
    ...
    describe('signup form', function() {
      it('should render', function(done) {
        rp(htmlGetRequestOptions('http://localhost:3000/auth/local/signup'))
          .then(function (res) {
            expect(res.indexOf('<form')).to.not.eq(-1);
          })
          .catch(function (err) {
